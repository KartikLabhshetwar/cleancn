...
- Support light and dark themes`,
  ...
  },
  {
    ...
    prompt: `Transform my website to use Fluent Design System principles.

## Style Overview
Microsoft's Fluent Design System featuring acrylic surfaces, depth, light, motion, and material. Creates a modern, layered interface with subtle transparency and smooth animations.

## Key Characteristics
- Acrylic surfaces with backdrop blur
- Layered depth through elevation
...
## Acrylic Effect
- Background: Semi-transparent (rgba(255,255,255,0.8))
...
## Color Palette
- Surfaces: Acrylic white/light with transparency
- Primary: Microsoft blue or brand color
- Text: Dark for contrast
- Accents: Subtle, complementary colors
- Borders: Semi-transparent (50% opacity)

## Elevation System
- Level 0: Base surface
- Level 1: Subtle shadow (0 2px 8px rgba(0,0,0,0.1))
- Level 2: Medium shadow (0 4px 16px rgba(0,0,0,0.15))
- Level 3: Strong shadow (0 8px 24px rgba(0,0,0,0.2))
- Acrylic blur increases with elevation
...
### Buttons
- Background: Primary color or acrylic
- Border radius: 4-6px
...
- Acrylic background
- Backdrop blur
- Sticky with increased blur on scroll
- Smooth transitions
...
## Implementation Guidelines
- Use backdrop-filter for acrylic effect
- Layer elements with proper z-index
- Add smooth transitions (200-300ms)
- Use elevation shadows for depth
- Ensure good contrast for readability
- Provide fallback for unsupported browsers
- Keep blur radius reasonable (12-20px)
...
- Ensure excellent readability`,
  ...
  },
  {
    ...
    prompt: `Transform my website to use Neumorphism design style.

## Style Overview
A soft UI design style that creates the illusion of extruded or recessed elements through the use of light and shadow. Elements appear to emerge from or sink into the background. NOTE: Use with caution for accessibility due to low contrast.

## Key Characteristics
- Soft, raised or recessed appearance
- Dual shadows: light source top-left, dark shadow bottom-right
- Low contrast between elements and background
- Large border radius for softness
- Subtle, tactile feel
- Elements appear to be part of the surface
- Minimal color variation

## Shadow System
- Light shadow: Top-left (inset or offset, lighter than background)
- Dark shadow: Bottom-right (offset, darker than background)
- Creates raised effect: 10px 10px 30px light, -10px -10px 30px dark
- Creates recessed effect: Inset shadows reversed
- Soft blur: 20-30px
- Subtle intensity

## Color Palette
- Background: Medium gray or beige (#E0E0E0, #E8E8E8)
- Elements: Slightly lighter or darker than background
- Text: Dark but low contrast (accessibility concern)
- Minimal color variation
...
- Shadow: 10px 10px 30px rgba(255,255,255,0.5), -10px -10px 30px rgba(0,0,0,0.1)
- Border: None
- Border radius: 20-24px
- Appears to emerge from surface
...
- Pressed: Inset shadows (recessed effect)

### Inputs (Recessed)
- Background: Slightly darker than surface
- Inset shadows: Creates sunk-in appearance
- Border: None
- Border radius: 12px
- Appears to be carved into surface

## Typography
- Font family: Clean sans-serif
- Font weights: Medium (500) to Bold (700)
- Text: Dark but may have contrast issues
- Clear, readable despite low contrast

## Accessibility Concerns
- Low contrast can cause readability issues
- Ensure text meets WCAG AA minimum (4.5:1)
- Consider adding borders for definition
- Test with users who have visual impairments
- May need to increase contrast for production use

## Implementation Guidelines
- Use dual shadow system (light + dark)
- Keep colors close to background
- Use large border radius (20px+)
- Remove borders
- Create soft, tactile appearance
